...
try:
    ...
    print(
        "LỖI: Không tìm thấy file 'water_potability.csv'. Vui lòng tải và đặt vào cùng thư mục."
    )
    exit()
...
feature_importance_df = pd.DataFrame(
    {"Thong_so": feature_names, "Diem_quan_trong": importances}
)

feature_importance_df = feature_importance_df.sort_values(
    by="Diem_quan_trong", ascending=False
)
...
plt.title(
    "Mức độ Quan trọng của các Thông số đến Chất lượng nước (Random Forest)",
    fontsize=16,
)
